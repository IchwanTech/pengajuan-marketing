            ...
            <ul type="A" style="margin: 0; padding-left: 0%">
                    ...
                    <div style="margin-left: 6%; margin-bottom: 2%;">
                        <table class="no-border">
                            ...
                            <tr>
                                ...
                                <td style="width: 5%">:</td>
                                <td>{{ $suratKontrak->tenor }} Periode</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="width: 45%;">Jumlah Cicilan/Periode</td>
                                <td style="width: 5%">:</td>
                                <td>Rp. {{ number_format($suratKontrak->cicilan, 0, ',', '.') }},-</td>
                            </tr>
                            <tr>
                                <td style="width: 45%;">Biaya Layanan/Periode</td>
                                <td style="width: 5%">:</td>
                ...
                <li>
                    ...
                    <ol type="1" style="text-align: justify;">
                        ...
                        <li style="margin-bottom:1%">
                            Bagi <strong>Peminjam&nbsp;</strong>yang menggunakan Jaminan BPJS Ketenagakerjaan apabila
                            tidak dapat
                            memenuhi kewajibannya untuk membayar Pinjaman dan Bunganya sebagaimana diatur pada
                            Perjanjian ini, maka <strong>Peminjam</strong> setuju dan sepakat untuk menggunakan harta
                            pribadinya untuk
                            dicairkan/diserahkan dan dipergunakan sebagai pembayaran sisa Pinjaman dan Bunganya
                            tersebut, seperti Saldo BPJS
                            Ketenagakerjaan yang sudah dijadikan Agunan ke Pihak <strong>Pemberi Pinjaman</strong>.
                        </li>
                        <li style="margin-bottom:1%">
                            Bagi <strong>Peminjam</strong> yang menggunakan Jaminan BPJS Ketenagakerjaan dilarang
                            mencairkan Jaminan Saldo BPJS Ketenagakerjaan apabila masih ada sisa pinjaman di
                            <strong>Cash Lentera Usaha
                                CG&nbsp;</strong>tanpa sepengetahuan pihak <strong>Pemberi
                                Pinjaman,&nbsp;</strong>Apabila nasabah melanggar dengan mencairkan saldo BPJS
                            Ketenagakerjaan tanpa sepengetahuan pihak&nbsp; Pemberi Pinjaman </strong>maka akan diproses
                            secara hukum (Pidana maupun Perdata).
                        </li>
                        <li style="margin-bottom:1%">
                            Bagi <strong>Peminjam</strong> yang menggunakan Jaminan BPJS Ketenagakerjaan
                            <strong>Peminjam&nbsp;</strong>bersedia membuat rekening baru an
                            <strong>Peminjam&nbsp;</strong>yang akan dibuatkan oleh pihak Pemberi Pinjaman.
                        </li>
                        <li style="margin-bottom:1%">
