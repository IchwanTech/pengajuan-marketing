                            ...
                            <div class="form-step form-step-active">
                                ...
                                @if ($pengajuan->nasabahLuar->validasi_nasabah == 0 || $pengajuan->status_pengajuan == 'revisi spv')
                                    <div class="form-group mt-0" id="catatan-nasabah">
                                        ...
                                        <textarea name="catatan_nasabah" id="catatan_nasabah" class="form-control" cols="30" rows="10" disabled>{{ $pengajuan->nasabahLuar->catatan ?? $pengajuan->catatan_spv }}</textarea>
                                    </div>
                                @endif
                                <div class="text-end">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="jenis_pembiayaan" id="jenis_pembiayaan" class="form-select">
                                        ...
                                        <option value="UMKM"
                                            ...
                                            UMKM</option>
                                        <option value="SF"
                                            {{ $pengajuan->jenis_pembiayaan === 'SF' ? 'selected' : '' }}>
                                            SF</option>
