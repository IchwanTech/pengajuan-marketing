        ...
        <div class="row">
            <div class="col-12 grid-margin">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="loanForm" action="{{ route('supervisor.approval.approval', $nasabah->id) }}"
                            method="POST">
                            @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" id="nominal_pinjaman" name="nominal_pinjaman"
                                            class="form-control"
                                            value="{{ $nasabah->pengajuan->nominal_pinjaman ?? '' }}">
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="form-step">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            @if ($nasabah->jaminan->foto_ktp_penjamin)
                                                <a href="{{ asset('storage/dokumen_pendukung/' . $folderNasabah . '/' . $nasabah->jaminan->foto_ktp_penjamin) }}"
                                                    target="_blank">
                                                    <img src="{{ asset('storage/dokumen_pendukung/' . $folderNasabah . '/' . $nasabah->jaminan->foto_ktp_penjamin) }}"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            @if ($nasabah->jaminan->foto_id_card_penjamin)
                                                <a href="{{ asset('storage/dokumen_pendukung/' . $folderNasabah . '/' . $nasabah->jaminan->foto_id_card_penjamin) }}"
                                                    target="_blank">
                                                    <img src="{{ asset('storage/dokumen_pendukung/' . $folderNasabah . '/' . $nasabah->jaminan->foto_id_card_penjamin) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="keterangan" id="keterangan" class="form-control" required style="width: 100%; height: 150px;"></textarea>
                                </div>

                                <div class="d-flex justify-content-between">
                                    <div class="text-first">
                                        <a href="{{ route('supervisor.approval') }}"
                                    ...
                                    <div class="text-end">
                                        ...
                                        {{-- <button type="button"
                                            class="btn btn-secondary prev-btn rounded">Previous</button> --}}
                                        {{-- <form action="{{ route('supervisor.approval.approve', $nasabah->id) }}"
                                        ...
                                        <form action="{{ route('supervisor.approval.reject', $nasabah->id) }}"
                                            method="POST" style="display:inline;">
                                            @csrf
                                            <button type="submit" class="btn btn-gradient-danger rounded">Reject</button>
                                        </form> --}}
